...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+5,0,"x",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->pushPrefix("fault", VerilatedTracePrefixType::SCOPE_MODULE);
    ...
    tracep->declBit(c+8,0,"c",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+9,0,"d",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+10,0,"x",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+5,(vlSelf->x));
    bufp->fullBit(oldp+6,(vlSelf->fault__DOT__a));
    bufp->fullBit(oldp+7,(vlSelf->fault__DOT__b));
    bufp->fullBit(oldp+8,(vlSelf->fault__DOT__c));
    bufp->fullBit(oldp+9,(vlSelf->fault__DOT__d));
    bufp->fullBit(oldp+10,(vlSelf->fault__DOT__x));
}
